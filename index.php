                        ...
                        while($rows=mysqli_fetch_assoc($execute)){
                            ...
                            <a href="categories.php">
                                <div class="card float-container">
                                    <img src="image/category/<?php echo $category_image; ?>" alt="<?php echo$category_title; ?>" class="img-responsive img-rounded">
                    ...
                    if($count > 0){
                        ...
                        while($pro_rows= mysqli_fetch_assoc($pro_exec)){
                           ...
                           ?>
                            <div class="box">
                                <div class="box-img">
                                    <img src="image/product/<?php echo $pro_image; ?>" alt="<?php echo $pro_title; ?>" class="img-responsive img-rounded">
                                </div>
                                <div class="box-desc">
