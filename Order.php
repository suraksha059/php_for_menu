        ...
        <div class="container">
            ...
            <form action="" method="post" class="form-horizontal">
                <fieldset>
                    ...
                    <div class="box-img">
                        <img src="image/product/<?php echo $pro_image; ?>" alt="<?php echo $pro_title; ?>"
                ...
                <fieldset>
                    ...
                    <input class="form-control" type="text" name="name" id="name" required placeholder="Eg.Suraksha Thapa">
    
                    <label for="">Email</label>
                    <input class="form-control" type="text" name="email" id="email" required placeholder="Eg.surakshyat09@gmail.com">
    
                    <label for="">Address</label>
                    <input class="form-control" type="text" name="address" id="address" required placeholder="Eg.Banepa-5,Kavre">
