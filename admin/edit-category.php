                ...
                <table class="table">
                        ...
                        <tr>
                            ...
                            <?php
                                        if($current_image != ""){
                                            ?>
                                            <td><img width="100" height="100" src="../image/category/<?php echo $current_image; ?>" alt="<?php echo $current_image; ?>"></td>
                                            <?php
                                        }else{
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    if(isset($_POST['submit'])){
        ...
        //upload file or image
         ...
         $destination_path = "../image/category/".$image;
         ...
         if($upload == false){
            ...
            if(file_exists("../image/category/".$current_image)){
                @unlink("../image/category/".$current_image);
            }
        }
    }else{
