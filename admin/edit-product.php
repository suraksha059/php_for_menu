                ...
                <table class="table">
                        ...
                        <tr>
                            ...
                            <?php
                                        if($current_image != ""){
                                            ?>
                                            <td><img width="100" height="100" src="../image/product/<?php echo $current_image; ?>" alt="<?php echo $current_image; ?>"></td>
                                            <?php
                                        }else{
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    if(isset($_POST['submit'])){
        ...
        //upload file or image
         ...
         $destination_path = "../image/product/".$image;
         ...
         if($upload == false){
            ...
            if(file_exists("../image/product/".$current_image)){
                @unlink("../image/product/".$current_image);
            }
        }
    }else{
